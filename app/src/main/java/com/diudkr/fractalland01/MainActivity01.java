...
public class MainActivity01 extends AppCompatActivity {
    ...
    void showPopup() {
        ...
        Button closeButton = popupView.findViewById(R.id.btn_close_about);
        ...
        FrameLayout mMainContainer = findViewById(R.id.main_container);
    ...
    protected void onResume() {
        super.onResume();
        Log.i("diudkr", "MainActivity01.onPostCreate");
        doHide();
                ...
                (new View.OnSystemUiVisibilityChangeListener() {
                    ...
                    public void onSystemUiVisibilityChange(int visibility) {
                        ...
                        if ((visibility & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0) {
                            // Note: The system bars are visible. Make any desired
